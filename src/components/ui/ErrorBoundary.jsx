...
export default class ErrorBoundary extends Component {
  ...
  componentDidCatch(error, info) {
    ...
    fetch('/api/client-error', {
      ...
      body: JSON.stringify({ message: error?.message, stack: error?.stack || info?.componentStack, path: window.location.pathname }),
      keepalive: true,
    }).catch(() => {})
  }
  ...
  render() {
    ...
    return (
      <main role="alert" className="min-h-screen bg-gray-950 text-gray-100 flex items-center justify-center p-6">

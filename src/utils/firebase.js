...
import { validatePortfolioImageDimensions, validatePortfolioImageMetadata } from './imageUpload'
...
export async function uploadPortfolioImage(file, folder = 'design-projects') {
  ...
  const extension = validatePortfolioImageMetadata(file)
  await validatePortfolioImageDimensions(file)
